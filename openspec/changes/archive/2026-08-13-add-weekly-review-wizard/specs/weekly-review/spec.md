...
The system SHALL provide a "Iniciar Revisão Semanal" action, reachable from the Sidebar, that activates the review wizard at Step 1 regardless of the page currently being viewed.

#### Scenario: Starting a review from any page
- **WHEN** a user clicks "Iniciar Revisão Semanal" while viewing any page
